    ...
    return {
        ...
        blocks: [
            ...
            },
            {
                type: 'text',
                text:
                    `늦은 밤 그리스 피레아스 항구, 당신은 수많은 컨테이너 틈에서 작은 손전등 불빛에 의지해 단서를 찾고 있다. 이윽고 특이한 컨테이너 무리를 발견한다. 컨테이너는 교차된 형태로 정렬되어 있다. 그 중 눈에 띄는 하얀색 컨테이너를 확인하려는 순간, 당신을 향해 강렬한 조명이 비춰진다.`,
                markdown: true,
            },
			{
				type: 'text',
			...
			},
			{
				type: 'text',
				text: 
					`"나도 알아. 난 그냥 그 자식이 탐정을 고용했다는 점에 열받았을 뿐이야. 자기가 잃어버려 놓고 날 의심받게 만들다니."`
			},
			{
				type: 'text',
				text: 
			...
			},
			{
				type: 'text',
				text: 
					`"놀랐지? 바닷속에 빠졌다고 들었을텐데. 번호는 하나씩 다 눌러봤어, 우린 머리쓰는걸 싫어해서 말이야. 하지만 저기 하얀 녀석은 그럴 수가 없는 것 같더군."`
			},
			{
				type: 'text',
				text: 
					`그는 이미 모든 상황을 파악하고 있는 듯하다. 그는 당신을 노려보며 말한다.`
			},
			{
				type: 'text',
				text: 
