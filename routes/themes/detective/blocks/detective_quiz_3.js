    ...
    return {
        ...
        blocks: [
            ...
            },
            {
                type: 'text',
                text:
                    `늦은 밤 그리스 피레아스 항구, 당신은 수많은 컨테이너 틈에서 작은 손전등 불빛에 의지해 단서를 찾고 있다. 이윽고 특이한 컨테이너 무리를 발견한다. 컨테이너는 교차된 형태로 정렬되어 있다. 그 중 특이해 보이는 하얀색 컨테이너를 확인하려는 순간, 당신을 향해 강렬한 조명이 비춰진다.`,
                markdown: true,
            },
			{
				type: 'text',
