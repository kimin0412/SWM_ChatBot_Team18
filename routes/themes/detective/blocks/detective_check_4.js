		...
		return {
			...
			blocks: [
				...
				},
				{
					type: 'text',
					text:
						`"희망봉에서 배가 습격을 받았을 때, 이곳에 들어와 몸을 숨겼소. 그리고 밖이 잠잠해지기만을 기다렸지. 이 바닥에서 해적들은 흔한 일이고, 이 안을 드나드는 법을 아는 사람은 오직 나 하나였으니. 버티면 된다고 생각했소. 그리고 내심 기뻤지, 목이 날아가진 않겠구나. 동정표를 받을 거리가 생겼으니."`,
					markdown: true,
				},
				{
					type: 'text',
				...
				},
				{
					type: 'text',
					text:
						`"하지만 문을 열었을 때 본 광경은 예상과는 달랐소. 다행히 문은 급하게 다시 닫았지만, 꼼짝없이 갇혀버린거요. 그리고 당신이 문을 열었고, 물건은 그들이 다 털어갔지. 난 이런 꼴이 된 채로 남겨졌소. 딱히 동정하지도 않더군. 당신도 그를 만나봤으니 알거요. 애초에 그런 감정따윈 없는 사람이었던 게야."`,
					markdown: true,
				},
				{
					type: 'text',
				...
				},
				{
					type: 'text',
					text:
						`"고통 없이 얻을 수 있는 것은 없다. 나는 여지껏 두려움에 떨기만 하며 살았소. 결국 이렇게 되는군."`,
					markdown: true,
				},
				{
					type: 'text',
