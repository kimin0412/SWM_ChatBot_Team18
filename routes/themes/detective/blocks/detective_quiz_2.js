...
module.exports = (data) => {
    ...
    return {
        ...
        blocks: [
            ...
            {
                type: 'text',
                text: `중국 상해, 당신은 커다란 판다 그림이 그려진 간판 아래 문으로 들어간다. 자욱한 담배 연기 속에서 당신은 커다란 테이블을 사이에 두고 앉아있는 네 사람을 발견한다. 어두운 조명 아래서 테이블 위에 놓인 마작판에 집중하던 그들은 인기척을 느끼자 고개를 일제히 당신 쪽으로 돌린다.`,
                markdown: true,
            },
            {
                type: 'text',
